...
class WC_Tag_Discount_Manager {
    ...
    private function get_discount_rules() {
        $default_rules = array(
            'product_tag_sale-10' => array('slug' => 'sale-10', 'discount' => 10, 'taxonomy' => 'product_tag'),
            'product_tag_sale-20' => array('slug' => 'sale-20', 'discount' => 20, 'taxonomy' => 'product_tag'),
            'product_tag_sale-30' => array('slug' => 'sale-30', 'discount' => 30, 'taxonomy' => 'product_tag'),
        );
        ...
        <div class="discount-card">
            ...
            <?php else : ?>
                <div class="product-preview">
                    <?php foreach ($preview as $product_id => $rule) :
    ...
    private function render_rules_tab() {
        ...
        if (empty($rules)) {
            $rules = array(array('taxonomy' => 'product_tag', 'slug' => '', 'discount' => ''));
        }
        ?>
        <div class="discount-card">
                ...
                <div class="schedule-grid">
                    <div class="schedule-box">
                        <h4>
                            ...
                            <?php if ($apply_enabled && $apply_datetime) : ?><span class="scheduled-badge"><?php esc_html_e('Scheduled', 'wc-tag-discount'); ?></span><?php endif; ?>
                        </h4>
                        <label>
                    ...
                    <div class="schedule-box">
                        <h4>
                            ...
                            <?php if ($reverse_enabled && $reverse_datetime) : ?><span class="scheduled-badge"><?php esc_html_e('Scheduled', 'wc-tag-discount'); ?></span><?php endif; ?>
                        </h4>
                        <label>
    ...
    public function handle_apply_discounts() {
        ...
        wp_safe_redirect(add_query_arg(
            array('page' => 'tag-discount-manager', 'message' => 'applied', 'count' => $count),
            admin_url('admin.php')
        ));
        exit;
    }
    ...
    public function handle_reverse_discounts() {
        ...
        wp_safe_redirect(add_query_arg(
            array('page' => 'tag-discount-manager', 'message' => 'reversed', 'count' => $count),
            admin_url('admin.php')
        ));
        exit;
    }
    ...
    public function handle_save_rules() {
        ...
        wp_safe_redirect(add_query_arg(
            array('page' => 'tag-discount-manager', 'tab' => 'rules', 'message' => 'rules_saved'),
            admin_url('admin.php')
        ));
        exit;
    }
    ...
    public function handle_save_schedule() {
        ...
        foreach (array('apply_datetime', 'reverse_datetime') as $field) {
            if ($schedule[$field] !== '' && strtotime($schedule[$field]) === false) {
                $schedule[$field] = '';
            }
        }
        ...
        wp_safe_redirect(add_query_arg(
            array('page' => 'tag-discount-manager', 'tab' => 'schedule', 'message' => 'schedule_saved'),
            admin_url('admin.php')
        ));
        exit;
    }
